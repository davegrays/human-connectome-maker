...
if [[ $# -ne 3 && $# -ne 5 ]]; then
	echo -e "\nUsage:	`basename $0` <subjectFolder> [</abspath/to/T1_file.nii> OR </abspath/to/T1_DICOMdir>] [</abspath/to/DTI_AFQproc.nii.gz> OR </abspath/to/DTI_DICOMdir>] [optional </abspath/to/fieldmap_MAG_DICOMdir> AND </abspath/to/fieldmap_PHASE_DICOMdir>]"
	...
	echo -e "OR"
	echo -e "	`basename $0` 101939-200_1 /home/david/W/data/APP/Images/DICOMs/101939-200_1/3t_2010-08-18_20-26/MPRAGE_folder /home/david/W/data/APP/Images/DICOMs/101939-200_1/3t_2010-08-18_20-26/DTI_folder "
	echo -e "etc. etc."
	exit 1
fi
...
#set FM variables
if [ $# -eq 5 ]; then
	rawFM_MAG=`readlink -f $4`
	MAGname=`echo ${rawFM_MAG} | sed 's/.*\///'`
	rawFM_PHASE=`readlink -f $5`
